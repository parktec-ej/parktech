    ...
    html: `
      <div style="font-family:Arial,sans-serif;line-height:1.8;color:#111">
        ...
        <div style="margin-top:20px;padding:14px 16px;border:1px solid #fde68a;border-radius:8px;background:#fffbeb;color:#92400e;font-size:13px;line-height:1.7">
          ...
          ・イベント日の駐車をご希望の場合は契約者ページから別途ご予約・追加料金が必要です。<br />
          ・イベント日の駐車をご希望かどうかは、開催14日前までに契約者ページからご回答ください。期限までにご回答がない場合、当日の区画は一般のお客様に開放されます。<br />
          ・イベント日に無断で駐車された場合、実際に発生した費用（当日の利用料金相当額、ご予約者への返金額、対応費用5,000円）のご負担をお願いいたします。<br />
          ・詳細は<a href="https://reserve.parktec-ej.com/monthly-terms">月極駐車場 利用規約</a>をご確認ください。
        </div>
...
・イベント日の駐車希望は契約者ページから別途予約・追加料金が必要です。
・ご希望の有無は開催14日前までに契約者ページからご回答ください。期限までに回答がない場合、当日の区画は一般のお客様に開放されます。
・イベント日に無断で駐車された場合、実際に発生した費用（当日の利用料金相当額、ご予約者への返金額、対応費用5,000円）のご負担をお願いいたします。
・月極駐車場 利用規約: https://reserve.parktec-ej.com/monthly-terms
