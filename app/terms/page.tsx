      ...
      <div className="mt-8 space-y-6 text-sm leading-7 text-gray-800">
        ...
        <section>
          <h2 className="text-xl font-semibold">
            第6条の2（時間貸し利用における出庫期限および超過時の取扱い）
          </h2>
          <ol className="mt-3 list-decimal space-y-2 pl-6">
            <li>
              時間貸しでご利用いただく区画に後続のご予約がある場合、当社は入庫時に
              出庫期限を表示します。出庫期限は、当該予約日の午前0時とします。
            </li>
            <li>利用者は、前号の出庫期限までに出庫するものとします。</li>
            <li>
              利用者が出庫期限を超えて駐車を継続した場合、当社は利用者に対し、
              次の各号の合計額を請求することができます。
              <ul className="mt-2 list-disc space-y-1 pl-6">
                <li>出庫期限を超えた時間に対応する時間貸し料金</li>
                <li>当社が当該予約者に返金した場合、その返金額に相当する額</li>
                <li>対応費用として5,000円</li>
              </ul>
            </li>
            <li>
              前号の対応費用は、出庫期限が深夜帯であることに鑑み、当社担当者の
              深夜・時間外対応および車両を用いた現地移動に要する費用に基づき
              定めたものです。
            </li>
          </ol>
        </section>
